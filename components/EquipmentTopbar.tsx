...
export function EquipmentTopbar({ title }: EquipmentTopbarProps) {
  return (
    <div className="flex h-[88px] shrink-0 items-center justify-between border-b border-slate-200 bg-white px-8">
      ...
      <div className="flex items-center gap-6">
        ...
        <div className="flex items-center gap-4 border-l border-slate-200 pl-6">
          ...
          <button className="flex h-10 w-10 items-center justify-center rounded-lg bg-[#0F52BA] text-white hover:bg-[#0b409c] transition-colors ml-2 shadow-sm">
            <Plus size={20} />
          </button>
        </div>
      </div>
